 ...
 */
public class TimePickerView_Original extends BasePickerView implements View.OnClickListener {
    public enum Type {
    ...
    public TimePickerView_Original(Context context, Type type) {
        super(context);
